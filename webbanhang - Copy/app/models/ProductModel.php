...
public function addProduct($name, $description, $price, $category_id, $image)
{
    ...
    try {
        ...
        $name = $name ? htmlspecialchars(strip_tags($name)) : '';
        $description = $description ? htmlspecialchars(strip_tags($description)) : '';
        $price = $price ? htmlspecialchars(strip_tags($price)) : 0;
        $category_id = $category_id ? htmlspecialchars(strip_tags($category_id)) : null;
        $image = $image ? htmlspecialchars(strip_tags($image)) : '';
